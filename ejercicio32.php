...
<html>
	...
	<!-- 
		EJERCICIO 32
			Texto sin sentido v2
			
	-->
	<h1 style="text-align:Center"> Exercici#32 Texto sin sentido v2</h1><br/>
		<?php		
			...
			function textoSinSentido($longPalabraMax,$numPalabras){
				...
				for ($i = 0; $i <$numPalabras; $i++) 
				{
					...
					for($i=1;$i<$numPalabras;$i++)
					{
						...
						$palabras .= "<p style=\"font-weight:600\">".substr($tempMezcla, 0, rand(1,$longPalabraMax)). "</p>";
					}
